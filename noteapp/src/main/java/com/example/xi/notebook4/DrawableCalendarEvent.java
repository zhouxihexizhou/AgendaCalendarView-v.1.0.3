...
public class DrawableCalendarEvent extends BaseCalendarEvent {
    ...
    public DrawableCalendarEvent(String week, String day ,String title, String description, String location, int color, Calendar startTime, Calendar endTime, boolean allDay, int drawableId) {
        super(week, day, title, description, location, color, startTime, endTime, allDay);
        this.mDrawableId = drawableId;
    }
