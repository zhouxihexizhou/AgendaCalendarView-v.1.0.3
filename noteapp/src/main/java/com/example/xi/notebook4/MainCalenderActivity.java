...
public class MainCalenderActivity extends AppCompatActivity implements CalendarPickerController{
    ...
    private void mockList(List<CalendarEvent> eventList) {
        ...
        dbHelper = new MyDatabaseHelper(MainCalenderActivity.this, "BookStore.db", null, 1);
        ...
        if(cursor.moveToNext()){
            do{
                ...
                startTime.set(Calendar.MONTH, cursor.getInt(cursor.getColumnIndex("month")));
                ...
                endTime.set(Calendar.MONTH, cursor.getInt(cursor.getColumnIndex("month")));
                ...
                BaseCalendarEvent event = new BaseCalendarEvent("第"+cursor.getString(cursor.getColumnIndex("week"))+"周","星期"+cursor.getString(cursor.getColumnIndex("weekday")),cursor.getString(cursor.getColumnIndex("title")), cursor.getString(cursor.getColumnIndex("weather")), cursor.getString(cursor.getColumnIndex("area")),
