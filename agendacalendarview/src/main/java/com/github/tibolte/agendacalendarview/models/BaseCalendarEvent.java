...
public class BaseCalendarEvent implements CalendarEvent {
    ...
    // region Constructor
    private String mSchoolWeek;
    private String mSchoolDay;
    /**
     ...
     */
    public BaseCalendarEvent(String day, String week, String title, String description, String location, int color, Calendar startTime, Calendar endTime, boolean allDay) {
        this.mSchoolWeek = week;
        this.mSchoolDay = day;
        this.mTitle = title;
        this.mDescription = description;
        this.mLocation = location;
    ...
    public void setSchoolWeek(String mSchoolWeek) {
        this.mSchoolWeek = mSchoolWeek;
    }
    ...
    public void setSchoolDay(String mSchoolDay) {
        this.mSchoolDay = mSchoolDay;
    }
