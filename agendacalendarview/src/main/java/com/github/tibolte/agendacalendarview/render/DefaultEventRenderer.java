...
public class DefaultEventRenderer extends EventRenderer<BaseCalendarEvent> {
    ...
    public void render(@NonNull View view, @NonNull BaseCalendarEvent event) {
        ...
        TextView txtSchool = (TextView) view.findViewById(R.id.view_agenda_event_school);
        TextView txtWeek = (TextView) view.findViewById(R.id.view_agenda_event_week);
        TextView txtContent = (TextView) view.findViewById(R.id.view_agenda_event_content);

        descriptionContainer.setVisibility(View.VISIBLE);
        txtTitle.setTextColor(view.getResources().getColor(android.R.color.black));

        txtSchool.setText(event.getSchoolWeek());
        txtWeek.setText(event.getSchoolDay());
        txtContent.setText(event.getDescription());
